...
class MessageManager:
    def __init__(
        ...
        include_attributes: list[str] = ["ClassName", "ControlType", "Name", "AutomationId"],
        ...
        # Pass current_date to SystemPrompt
        ...
        tool_calls = [
            {
                ...
                'args': {
                    'current_state': {
                        ...
                        'next_goal': 'Start desktop interaction',
                    },
                    'action': [],
                },
                'id': str(self.tool_id),
        ...
        tool_message = ToolMessage(
            content=f'Desktop interaction started',
    ...
    def add_state_message(
        ...
        """Add desktop state as human message"""
        ...
        state_message = AgentMessagePrompt(
            ...
            step_info=step_info,
        ).get_user_message(use_screenshot)
